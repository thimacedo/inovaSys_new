...
export const historyService = {
  ...
  addEntry: async (processoId: string, titulo: string, tipo: HistoryEntity['tipo'], descricao?: string, autorId?: string) => 
    DependencyRegistry.getHistoryRepository().addEntry(processoId, titulo, tipo, descricao, autorId)
};
